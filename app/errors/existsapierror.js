 ...
 */
 ...
 const ExistsAPIError = function ExistsAPIError (response = null, request = null, cause = null) {
  ...
  this.reason = (response.data && response.data.reason ? response.data.reason : 'EXISTS');

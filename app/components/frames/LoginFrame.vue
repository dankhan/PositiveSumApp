<template>
    <!-- A Popup Frame to show the login content -->
    <Frame :id="frameId" @loaded="popupFrameLoaded">
        <Login :frame="frameId" :isPopover="true" />
    </Frame>
</template>
...
export default {
    ...
    computed: {
        popupFrameActivateCallback: {
            get() { return this.$store.getters['LoginFrame/activateCallback']; },
            set(value) { this.$store.commit('LoginFrame/SET_ACTIVATE_CB', value); },  
        },

        popupFrameDeactivatedCallback: {
            get() { return this.$store.getters['LoginFrame/deactivatedCallback']; },
            set(value) { this.$store.commit('LoginFrame/SET_DEACTIVATED_CB', value); },
        },

        closePopup: {
            get() { return this.$store.getters['LoginFrame/closeCallback']; },
            set(value) { this.$store.commit('LoginFrame/SET_CLOSE_CB', value); },
        },
        
        popupRoute: {
            get() { return this.$store.getters['LoginFrame/currentRoute']; },
            set(value) { this.$store.commit('LoginFrame/SET_CURRENT_ROUTE', value); },
        },

        popupVisible: {
            get() { return this.$store.getters['LoginFrame/visible']; },
            set(value) { this.$store.commit('LoginFrame/SET_VISIBLE', value); },
        },
    },

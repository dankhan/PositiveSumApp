  ...
  <Page actionBarHidden="true" @loaded="onPageLoaded">
    <GridLayout rows="90,auto" iosOverflowSafeArea="true" class="page-container">
        ...
        <StackLayout row="1" verticalAlignment="top" horizontalAlignment="center">
            <Label class="" row="1" horizontalAlignment="center" :textWrap="true" text="Check Your Email TODO:"></Label>
            <Label class="" :textWrap="true" marginTop="50" text="[Open Mail App]" @tap="onSubmit"></Label>
        </StackLayout>        
    </GridLayout>
  </Page>
</template>
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            this.$goto('signUpPassword', this.navOptions);
        },

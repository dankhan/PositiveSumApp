  ...
  <Page actionBarHidden="true" @loaded="onPageLoaded">
    <GridLayout rows="90,auto" iosOverflowSafeArea="true" class="page-container">
        ...
        <GridLayout row="0" columns="*,*,*" iosOverflowSafeArea="true" class="page-container">
            ...
            <Label col="1" class="" horizontalAlignment="center" :textWrap="true" text="Reset" />
        ...
        <StackLayout row="1" verticalAlignment="top" horizontalAlignment="center">
            <Label class="" row="1" horizontalAlignment="center" :textWrap="true" text="Forgotten password page TODO:" />
            <Label class="" :textWrap="true" marginTop="50" text="[Reset Password]" @tap="onSubmit" />
        </StackLayout>        
    </GridLayout>
  </Page>
</template>
...
export default {
    ...
    methods: {
        ...
        onHelp() {
            this.$goto('forgotPasswordHelp', this.navOptions);
        },
        
        onSubmit() {
            this.$goto('forgotPasswordCheckEmail', this.navOptions);
        },

<template>
    <Page actionBarHidden="true" @loaded="onPageLoaded">
        <GridLayout rows="90,auto" iosOverflowSafeArea="true" class="page-container" v-if="!loadingDashboard">
        ...
        <!-- Top Nav -->
            ...
            <StackLayout row="1" verticalAlignment="top" horizontalAlignment="center">
                <Label class="" :textWrap="true" text="Login page TODO:"></Label>
                <Label class="" :textWrap="true" marginTop="50" text="[Login]" @tap="onSubmit"></Label>
                <Label class="" :textWrap="true" marginTop="50" text="Forgotten Password" @tap="onTapForgot"></Label>
                <Label class="" :textWrap="true" marginTop="50" v-if="fromChangePassword" text="(From changePassword page)"></Label>
            </StackLayout>
        </GridLayout>

        <!-- Loading page -->
        <Stacklayout horizontalAlignment="center" verticalAlignment="middle" v-if="loadingDashboard">
            <label class="blurb" text="Loading..." marginBottom="50"></Label>
...
export default {
    ...
    methods: {
        ...
        onTapForgot() {
            this.$goto('forgotPassword', this.navOptions);
        },
        ...
        onSubmit() {
            ...
            setTimeout(() => {
                setTimeout( () => this.$goto('home', { clearHistory: true, backstackVisible: true, props: { 'fromLogin': true }} ), 50);
            }, 50);
        },

<template>
  <Page actionBarHidden="true" @loaded="onPageLoaded">
    <DockLayout>
        <!-- Top Nav -->
        <TopNav dock="top" title="TODO" :leftIsBackButton="true" :rightIsHelpButton="true" rightRoute="TODO" />

        <!-- Bottom container -->
        <GridLayout rows="auto, auto" columns="*" dock="bottom" verticalAlignment="bottom" marginLeft="20" marginRight="20" marginBottom="10">
            <StackLayout>
                <Label class="paragraph" text="TODO: CheckInGroup"></Label>
                <Label class="paragraph" :textWrap="true" :text="JSON.stringify(item)"></Label>
            </StackLayout>
        </GridLayout>
    </DockLayout>
  </Page>
